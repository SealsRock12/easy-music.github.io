...
var pieces = [
  [
    ...
    "../../img/composer-img-no-name/mozart.jpg",
  ...
  [
    ...
    "mozart-turkish",
    "Sonata No. 11, K. 331 (Turkish March)",
  ],
  [
    "../../img/display-img/mozart-eine.jpg",
    "../../img/composer-img-no-name/mozart.jpg",
    "../../audio/mozart-eine-audio.mp3",
    "mozart-eine",
    "Serenade No. 13, K. 525 (Eine kleine Nachtmusik)",
  ],
  [
    "../../img/display-img/mozart-no25.jpg",
    "../../img/composer-img-no-name/mozart.jpg",
    "../../audio/mozart-no25-audio.mp3",
    "mozart-no25",
